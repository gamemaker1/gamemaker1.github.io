...
I worked on [AgentTorch](#agent-torch) with MIT Media Lab's Large
Population Models team in 2024, and on
[function calling in the Gemma 3 family of models](/projects/offline-function-calling)
...
[express-slow-down](#express-slow-down), used to shield servers from
DDOS attacks, with their original author
[Nathan Friedly](https://github.com/nfriedly). I am also a contributor
to [serve](#serve), [Refined Github](#refined-github), [FPM](#fpm),
[Beckn](#beckn), [Sunbird Registries and Credentials](#sunbird-rc). I
co-created the [Mess Portal](https://mess.iiit.ac.in) and associated
systems at IIIT Hyderabad with [Aarnav Pai](https://github.com/arnu515),
